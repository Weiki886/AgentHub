#!/usr/bin/env bash
#
# install.sh -- 将 AgentHub 智能体安装到本地 AI 工具中
#
...
#   openclaw     -- 复制到 ~/.openclaw/agenthub/
...
install_gemini_cli() {
  ...
  local dest="${HOME}/.gemini/extensions/agenthub"
  local count=0
...
install_openclaw() {
  ...
  local dest="${HOME}/.openclaw/agenthub"
  local count=0
